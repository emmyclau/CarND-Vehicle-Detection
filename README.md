...
1. I chose 5 sizes of the sliding window with scales (1, 1.5, 2, 2.5 and 4) of default window 64 x 64 and limited the area that each sliding window can search.  
